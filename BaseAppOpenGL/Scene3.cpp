...
void CScene3::DrawPyramid()
{
	...
	glTexCoord2f(0.02f, 0.1f);
	glTexCoord2f(0.435f, 0.1f);
	glTexCoord2f(0.23f, 0.45f);
	...
	glTexCoord2f(0.935f, 0.1f); glVertex3f(0.5f, -0.5f, -0.5f);
	glTexCoord2f(0.73f, 0.45f); glVertex3f(0.0f, 0.5f, 0.0f);

	// Face esquerda
	glTexCoord2f(0.02f, 0.55f); glVertex3f(0.5f, -0.5f, -0.5f);
	glTexCoord2f(0.435f, 0.55f); glVertex3f(-0.5f, -0.5f, -0.5f);
	glTexCoord2f(0.23f, 0.9f); glVertex3f(0.0f, 0.5f, 0.0f);

	// Face trás
	glTexCoord2f(0.52f, 0.55f);  glVertex3f(-0.5f, -0.5f, -0.5f);
	glTexCoord2f(0.935f, 0.55f); glVertex3f(-0.5f, -0.5f, 0.5f);
